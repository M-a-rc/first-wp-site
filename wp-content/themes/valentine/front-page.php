...
<div class="image-right-wrapper">
  ...
  <div class="image-right-wrapper-right-part dble-container-eq-right-padding">
    <div class="image-right-wrapper-image " style="background-image: url(<?php the_field('image-bloc-1') ?>)">
...
<div class="discover-wrapper">
  ...
  <div class="small-collection">
    <div class="small-collection-sub-div">
      <img src="<?php the_field('logo-service-1') ?>" alt="logo service 1">
      <p class="text-center"><?php the_field('service-1') ?></p>
    </div>
    <div class="small-collection-sub-div">
      <img src="<?php the_field('logo-service-2') ?>" alt="logo service 2">
      <p class="text-center"><?php the_field('service-2') ?></p>
    </div>
    <div class="small-collection-sub-div">
      <img src="<?php the_field('logo-service-3') ?>" alt="logo service 3" >
...
<div class="quarter-text-wrapper">
  <div class="quarter-text-wrapper-text">
    ...
    <div class="quarter-text-background-image only-desktop" style="background-image: url(<?php the_field('image-bloc-3')?>)"></div>
  </div>
</div>
